"""
Django settings for raul_point_collector project.
...
SECRET_KEY = 'django-insecure-qjr7@aoe+fkiqc&f8p-tkhq4vv&(5o8b&i5sb=5v(ao)r-vrbp'
...
ROOT_URLCONF = 'raul_point_collector.urls'
...
WSGI_APPLICATION = 'raul_point_collector.wsgi.application'
